...
{
  #initialisation
  d=by_word_type(d_comprehension, sample_size, range_of_age, FALSE, 1)
...
```{r, echo=FALSE, message=FALSE}
#R2=mean_R2_over_CDI_reports(d_comprehension, data_algo, 70, c(8:18), 10, c('TPs', 'PUDDLE', 'DiBs', 'AGu', 'gold'),c("syllable", "phoneme"))
dat=merge(dd, data_algo, by="Type")
R2=Linear_model(dat,c(8:18), c('TPs', 'PUDDLE', 'DiBs', 'AGu', 'gold'),c("syllable", "phoneme"))

png("/Users/elinlarsen/Google Drive/PhD_elin/our_papers/CogSci2018/figures/R2_over_ages_bis.png",width=4500,height=2500, res=200 )
