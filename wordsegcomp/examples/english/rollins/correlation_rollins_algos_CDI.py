...
PATH_PACKAGE="/Users/elinlarsen/GoogleDrive/PhD_elin/Projets/WordSegComprehension/wordsegcomp/"
os.chdir(PATH_PACKAGE + '/pipeline')
...
# *******  parameters *****
df_gold=analyze.freq_token_in_corpus(path_gold)
df_gold.to_csv(path_res+ "gold/syllable/freq-top.txt", sep='\t', index=False)


d_g=analyze.create_freq_top_gold(path_data,path_res, [''])
...
#algo results
algos=['tp/relativeforward', 'tp/absoluteforward', 'tp/relativebackward', 'tp/absolutebackward','dibs','puddle','XS_segmentation']
d=create_file_word_freq(path_res, dic_corpus, [''], ["gold", 'XS_segmentation'],"syllable", freq_file="/freq-top.txt")
